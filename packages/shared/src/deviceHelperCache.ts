 ...
 *
 * This lives in `@veylen/shared` because two independent callers derive the
...
/** `~/Library/Caches/veylen/device-helper` — callers pass their own home dir. */
...
export const DEVICE_HELPER_BINARY_NAME = "veylen-device-helper";

/** Physical helper source directory passed from packaged desktop to its backend child. */
export const DEVICE_HELPER_SOURCE_DIR_ENV = "VEYLEN_DEVICE_HELPER_SOURCE_DIR";
