...
const PATHS = {
  homeDir: "/Users/demo",
  chatWorkspaceRoot: "/Users/demo/Documents/Veylen",
};

describe("resolveChatContainerWorkspaceRoot", () => {
  it("prefers the configured chat root and falls back to the home directory", () => {
    expect(resolveChatContainerWorkspaceRoot(PATHS)).toBe("/Users/demo/Documents/Veylen");
...
describe("matchesLegacyHomeChatWorkspaceRoot", () => {
  it("matches the chat root and the home directory, tolerating trailing slashes", () => {
    expect(matchesLegacyHomeChatWorkspaceRoot("/Users/demo/Documents/Veylen/", PATHS)).toBe(true);
...
describe("isOrdinaryProjectRow", () => {
  ...
  it("rejects the managed chat container and the legacy Home row by shape", () => {
