...
// the shareable activity card. All metrics are backed by Veylen's local DB
...
export const ProfileActivity = Schema.Struct({
  ...
  // totalPromptsSent), i.e. days the user actually used Veylen.
...
// Token totals come from Veylen's projected context-window updates. `available`
