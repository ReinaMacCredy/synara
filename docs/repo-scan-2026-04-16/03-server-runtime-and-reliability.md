...
[`apps/server/src/codexAppServerManager.ts`](/Users/emanueledipietro/Developer/Testing/veylen/apps/server/src/codexAppServerManager.ts) appears to own too many runtime concerns in one place:
