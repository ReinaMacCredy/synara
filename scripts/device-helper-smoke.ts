...
import { decodeDeviceFrame } from "@veylen/shared/deviceFrame";
import {
...
async function main(): Promise<void> {
  ...
  // comes from @veylen/shared so this build lands in the same directory the
  ...
  try {
    ...
    const socketDir = mkdtempSync(join(tmpdir(), "veylen-device-smoke-"));
