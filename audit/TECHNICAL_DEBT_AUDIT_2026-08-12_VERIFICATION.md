...
| `bun run --cwd apps/web test:electron:e2e`                                                                        | PASS           | Both native tests passed in 15.7s. Annotation focus remains inside the closed-shadow picker, while ambient keyboard/pointer input (including OAuth popups) is filtered without hiding the explicit manual-takeover proof.                   |
