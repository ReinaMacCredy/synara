...
const sourcemapEnv = process.env.VEYLEN_DESKTOP_SOURCEMAP?.trim().toLowerCase();
...
export default defineConfig([
  {
    ...
    define: {
      __VEYLEN_WINDOWS_UPDATER_PUBLISHER__: JSON.stringify(windowsUpdaterPublisher),
    },
    noExternal: (id) => id.startsWith("@veylen/"),
  },
  {
    ...shared,
