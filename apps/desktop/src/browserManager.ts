...
import { isBrowserCopyLinkChord } from "@veylen/shared/browserShortcuts";
import {
...
export class DesktopBrowserManager {
  ...
  private scheduleWindowOpenTab(input: {
    ...
    // runtimes. Only the first decision may create a canonical Veylen tab.
    if (
  ...
  attachWebview(input: BrowserAttachWebviewInput, hostWebContentsId: number): ThreadBrowserState {
    ...
    if (
      ...
      throw new Error("The browser webview does not belong to this Veylen window and partition.");
    }
