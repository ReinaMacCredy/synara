...
// Layer: Web UI state
// Why: "Void" is Veylen's word for "not filed yet", and it is the one Space label a user
...
import { SPACE_NAME_MAX_LENGTH } from "@veylen/contracts";
...
const STORAGE_KEY = "veylen:void-space:v1";
