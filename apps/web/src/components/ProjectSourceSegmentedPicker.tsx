...
/**
 * The compact raised-thumb picker previously used for the Veylen/Studio switch,
        ...
        {PROJECT_SOURCES.map((source, index) => {
          ...
          return (
            <button
              ...
              title={
                sourceUnavailable ? "Update the Veylen server to add GitHub projects." : undefined
              }
              className={cn(
