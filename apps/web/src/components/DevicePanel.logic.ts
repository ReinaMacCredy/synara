...
import { DEVICE_CAPABILITY_LABELS } from "@veylen/contracts";
  ...
  switch (availability.kind) {
    ...
    case "unsupported-platform":
      return {
        ...
        description: `This Veylen server runs on ${availability.platform}. Simulators are only available when the server runs on a Mac with Xcode installed.`,
        steps: [],
        retryable: false,
      };
    case "setup-required":
 ...
 * destination Veylen can send them to — every other step either completes on
