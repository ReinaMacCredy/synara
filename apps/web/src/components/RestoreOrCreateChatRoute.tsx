...
//          route to restore, falling back to creating a fresh draft.
// Layer: Routing
...
export function RestoreOrCreateChatRoute({
  ...
  // Surface-specific policy for picking the thread route to restore. The remembered-route
  // recovery below still keys off the total thread count.
