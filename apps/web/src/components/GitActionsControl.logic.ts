...
import { isTemporaryWorktreeBranch, resolveUniqueVeylenBranchName } from "@veylen/shared/git";
...
export function resolveDefaultCreateBranchName(
  ...
  return resolveUniqueVeylenBranchName(existingBranchNames, preferredBranch);
}
...
export { resolveAutoFeatureBranchName } from "@veylen/shared/git";
