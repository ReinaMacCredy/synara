...
export const SETTINGS_NAV_ITEMS: readonly SettingsNavItem[] = [
  ...
  },
  {
    ...
    group: "personal",
    label: "Notifications",
    description: "Choose how Veylen tells you when work finishes or needs attention.",
    icon: "bell",
    eyebrow: "Alerts",
  },
  {
  ...
  },
  {
    ...
    group: "personal",
    label: "Keybindings",
    description: "Capture, customize, and add shortcuts for every Veylen command.",
    icon: "shortcut",
  ...
  },
  {
    ...
    description: "Give Codex, Claude, and other local agents scoped access to Veylen tasks.",
    icon: "plugin-1",
  ...
  },
  {
    ...
    description: "Review and clean up isolated workspaces created by Veylen.",
    icon: "branch-simple",
