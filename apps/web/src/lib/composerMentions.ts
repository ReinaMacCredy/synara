...
import type { ProviderMentionReference, ProviderSkillReference } from "@veylen/contracts";
import { isThreadMentionPath, threadIdFromThreadMentionPath } from "@veylen/shared/threadMentions";
