...
export const FAVORITE_MODEL_STORAGE_KEYS = {
  cursor: "veylen:cursor-favourite-models:v1",
  kilo: "veylen:kilo-favourite-models:v1",
  opencode: "veylen:opencode-favourite-models:v1",
  pi: "veylen:pi-favourite-models:v1",
} as const;
