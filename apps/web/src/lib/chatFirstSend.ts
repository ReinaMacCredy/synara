import { DEFAULT_MODEL_BY_PROVIDER, type ModelSelection } from "@veylen/contracts";
...
export function resolvesFirstSendTargetToProject(resolution: FirstSendTargetResolution): boolean {
