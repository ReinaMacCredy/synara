...
// Purpose: Detects when a normal chat prompt is actually asking Veylen to create an automation.
...
import { completionPolicyFromStopWhen } from "@veylen/shared/automationCompletionPolicy";
