...
// A provider whose latest version Veylen cannot look up (self-updating CLIs such as
...
// Header affordance: reserved for providers Veylen can actually assert are outdated.
