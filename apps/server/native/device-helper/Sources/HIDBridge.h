...
typedef NS_ENUM(NSInteger, VeylenHardwareButton) {
  VeylenHardwareButtonHome,
  VeylenHardwareButtonLock,
  VeylenHardwareButtonSide,
  VeylenHardwareButtonSiri,
  VeylenHardwareButtonVolumeUp,
  VeylenHardwareButtonVolumeDown,
};
...
@interface VeylenHIDBridge : NSObject
...
- (void)tapButton:(VeylenHardwareButton)button NS_SWIFT_NAME(tapButton(_:));
