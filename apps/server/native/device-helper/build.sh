#!/bin/bash
# Compiles veylen-device-helper with the user's own Xcode toolchain.
#
...
#   VEYLEN_DEVICE_HELPER_OUT=/path build.sh
#
...
OUT_DIR="${1:-${VEYLEN_DEVICE_HELPER_OUT:-$SOURCE_DIR/build}}"
BINARY_NAME="veylen-device-helper"
