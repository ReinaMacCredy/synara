...
const logPath = process.env.VEYLEN_ACP_CONFORMANCE_LOG_PATH;
const malformedPrefix = process.env.VEYLEN_ACP_CONFORMANCE_MALFORMED_PREFIX === "1";
...
const app = agent({ name: "veylen-official-sdk-conformance-agent" })
