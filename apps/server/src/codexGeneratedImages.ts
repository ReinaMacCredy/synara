...
import { isSupportedLocalImagePath as isSupportedLocalImagePathShared } from "@veylen/shared/localPreviewFiles";
 ...
 * writes images under for the current process env. Veylen uses its isolated
 ...
 * overlay `<VEYLEN_HOME>/codex-home-overlay/generated_images` so we serve
