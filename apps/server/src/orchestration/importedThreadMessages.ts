...
// Purpose: Normalizes provider-native transcript snapshots into Veylen import messages.
...
import { MessageId, type ThreadHandoffImportedMessage, type ThreadId } from "@veylen/contracts";
