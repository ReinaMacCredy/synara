import { CommandId, type ProviderRuntimeEvent, type ThreadId } from "@veylen/contracts";
...
const make = Effect.gen(function* () {
  ...
  const processProviderEvent = (event: ProviderRuntimeEvent) => {
    // Native subagent lifecycle events carry the parent Veylen thread id and the child identity
