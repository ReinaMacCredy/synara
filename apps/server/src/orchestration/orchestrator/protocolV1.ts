...
Provider-native subagents are provider-owned helpers, not standalone Synara threads. They do not inherit this thread's Synara ownership authority and must not call synara_orchestrator_* mutation tools.`;
...
When no active TaskProcess exists, create and select one with synara_task_process_create before decomposing or assigning work.
