...
Create a TaskProcess only when the work actually needs a durable task graph or Assignment. A direct peer conversation does not require a TaskProcess. Use the canonical Synara Orchestrator native tools directly; never route these operations through MCP.
