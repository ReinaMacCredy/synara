...
import type { ChatAttachment, ProviderKind, ThreadId } from "@veylen/contracts";
...
const PROVIDER_ATTACHMENT_STORAGE_PATH = Symbol("veylen.providerAttachmentStoragePath");
