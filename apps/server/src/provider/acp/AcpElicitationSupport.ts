...
// Purpose: Bridges ACP form elicitation schemas to Veylen's provider-neutral question UI.
...
// Converts primitive ACP form fields into the question shape consumed by Veylen's composer.
