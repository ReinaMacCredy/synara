 ...
 */
import { type CursorModelOptions, type ProviderModelDescriptor } from "@veylen/contracts";
import { formatModelDisplayName, parseCursorCliReasoningEffort } from "@veylen/shared/model";
...
// Cursor exposes "auto" as a `default` model id over ACP; keep Veylen's "auto"
