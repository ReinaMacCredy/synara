...
import type { ModelSelection, ProviderKind, ProviderModelDescriptor } from "@veylen/contracts";
...
describe("agent gateway target resolver", () => {
  ...
  it.effect("fails closed before discovery when Veylen disables a provider", () =>
    Effect.gen(function* () {
