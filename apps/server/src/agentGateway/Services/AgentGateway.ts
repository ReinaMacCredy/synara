/**
 * AgentGateway - Veylen app-control tool surface for provider agents.
 *
 * Serves the `veylen_*` MCP tools that let any provider session (Codex,
 * Claude, Grok, ...) inspect and control Veylen itself: list projects and
...
export class AgentGateway extends ServiceMap.Service<AgentGateway, AgentGatewayShape>()(
  "veylen/agentGateway/Services/AgentGateway",
) {}
