/**
 * AgentGatewayCredentials - Per-session credentials for the Veylen agent
 * gateway.
 *
...
export interface AgentGatewayCredentialsShape {
  /** Streamable-HTTP MCP endpoint served by this Veylen instance. */
...
>()("veylen/agentGateway/Services/AgentGatewayCredentials") {}
