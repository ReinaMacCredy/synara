...
import { IsoDateTime, NonNegativeInt, SpaceIconName, SpaceId, SpaceName } from "@veylen/contracts";
...
>()("veylen/persistence/Services/ProjectionSpaces/ProjectionSpaceRepository") {}
