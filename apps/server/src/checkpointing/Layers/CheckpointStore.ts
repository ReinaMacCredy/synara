  ...
  const captureCheckpointOnce: CheckpointStoreShape["captureCheckpoint"] = (input) =>
    Effect.gen(function* () {
      ...
      yield* Effect.acquireUseRelease(
        fs.makeTempDirectory({ prefix: "veylen-fs-checkpoint-" }),
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "Veylen",
              GIT_AUTHOR_EMAIL: "veylen@users.noreply.github.com",
              GIT_COMMITTER_NAME: "Veylen",
              GIT_COMMITTER_EMAIL: "veylen@users.noreply.github.com",
            };
            ...
            const message = `Veylen checkpoint ref=${input.checkpointRef}`;
  ...
  const reverseCheckpointDiff: CheckpointStoreShape["reverseCheckpointDiff"] = (input) =>
    Effect.gen(function* () {
      ...
      return yield* Effect.acquireUseRelease(
        fs.makeTempDirectory({ prefix: "veylen-checkpoint-undo-" }),
        (tempDir) =>
          Effect.gen(function* () {
