...
import { deepMerge, type DeepPartial } from "@veylen/shared/Struct";
import { applyServerSettingsPatch } from "@veylen/shared/serverSettings";
import {
  Cause,
  Deferred,
  Effect,
...
export class ServerSettingsService extends ServiceMap.Service<
  ...
  ServerSettingsShape
>()("veylen/serverSettings/ServerSettingsService") {
