...
const USAGE = "Usage: veylen-restore-migration-backup <absolute-database-path>";
const STOP_PROCESSES_WARNING =
  "WARNING: Stop every Veylen process before restoring a migration backup.";
...
const entryPointNames = new Set([
  ...
  "veylen-restore-migration-backup",
]);
