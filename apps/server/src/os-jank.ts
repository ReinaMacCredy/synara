...
import { createCachedLoginShellPathReader } from "@veylen/shared/loginShellEnvironment";
import {
...
export function fixPath(
  ...
  try {
    ...
    // Cached by default: the probe result is persisted under the Veylen home and reused
...
export const resolveBaseDir = (raw: string | undefined): Effect.Effect<string> =>
  Effect.succeed(resolveVeylenHomeDirectory({ configuredHome: raw }));
