...
import type { ServerProviderUsageLimit, ServerProviderUsageLine } from "@veylen/contracts";
...
// The token was already redeemed (by the CLI, or another Veylen process): the file likely holds
